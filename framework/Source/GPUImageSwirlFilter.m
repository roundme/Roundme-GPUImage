...
- (id)init;
{
    ...
    angleUniform = [self.filterProgram uniformIndex:@"angle"];
...
- (void)setAngle:(GLfloat)newValue;
{
    _angle = newValue;

    [self setFloat:_angle forUniform:angleUniform program:self.filterProgram];
}
