...
- (id)init;
{
    ...
    minUniform = [self.filterProgram uniformIndex:@"levelMinimum"];
    midUniform = [self.filterProgram uniformIndex:@"levelMiddle"];
    maxUniform = [self.filterProgram uniformIndex:@"levelMaximum"];
    minOutputUniform = [self.filterProgram uniformIndex:@"minOutput"];
    maxOutputUniform = [self.filterProgram uniformIndex:@"maxOutput"];
...
- (void)updateUniforms {
    [self setVec3:minVector forUniform:minUniform program:self.filterProgram];
    [self setVec3:midVector forUniform:midUniform program:self.filterProgram];
    [self setVec3:maxVector forUniform:maxUniform program:self.filterProgram];
    [self setVec3:minOutputVector forUniform:minOutputUniform program:self.filterProgram];
    [self setVec3:maxOutputVector forUniform:maxOutputUniform program:self.filterProgram];
}
