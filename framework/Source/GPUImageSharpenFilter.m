...
- (id)init;
{
    ...
    sharpnessUniform = [self.filterProgram uniformIndex:@"sharpness"];
    self.sharpness = 0.0;
    
    imageWidthFactorUniform = [self.filterProgram uniformIndex:@"imageWidthFactor"];
    imageHeightFactorUniform = [self.filterProgram uniformIndex:@"imageHeightFactor"];
...
- (void)setSharpness:(GLfloat)newValue;
{
    _sharpness = newValue;
    
    [self setFloat:_sharpness forUniform:sharpnessUniform program:self.filterProgram];
}
