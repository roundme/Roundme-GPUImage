...
- (id)init;
{
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        secondFilterProgram = [[GLProgram alloc] initWithVertexShaderString:kGPUImageColorAveragingVertexShaderString fragmentShaderString:kGPUImageLuminosityFragmentShaderString];
...
//
//        GLfloat currentRedTotal = 0.0f, currentGreenTotal = 0.0f, currentBlueTotal = 0.0f, currentAlphaTotal = 0.0f;
//        NSUInteger totalNumberOfPixels = totalBytesForImage / 4;
//
//        for (NSUInteger currentPixel = 0; currentPixel < totalNumberOfPixels; currentPixel++)
//        {
//            currentRedTotal += (GLfloat)rawImagePixels2[(currentPixel * 4)] / 255.0f;
//            currentGreenTotal += (GLfloat)rawImagePixels2[(currentPixel * 4) + 1] / 255.0f;
//            currentBlueTotal += (GLfloat)rawImagePixels2[(currentPixel * 4 + 2)] / 255.0f;
//            currentAlphaTotal += (GLfloat)rawImagePixels2[(currentPixel * 4) + 3] / 255.0f;
//        }
//
//        NSLog(@"Stage %d average image red: %f, green: %f, blue: %f, alpha: %f", currentStage, currentRedTotal / (GLfloat)totalNumberOfPixels, currentGreenTotal / (GLfloat)totalNumberOfPixels, currentBlueTotal / (GLfloat)totalNumberOfPixels, currentAlphaTotal / (GLfloat)totalNumberOfPixels);
//
//
...
- (void)extractLuminosityAtFrameTime:(CMTime)frameTime {
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        GLfloat normalizedLuminosityTotal = (GLfloat)luminanceTotal / (GLfloat)totalNumberOfPixels / 255.0f;
