...
- (id)init;
{
    ...
    opacityUniform = [self.filterProgram uniformIndex:@"opacity"];
    self.opacity = 1.0;
...
- (void)setOpacity:(GLfloat)newValue;
{
    _opacity = newValue;
    
    [self setFloat:_opacity forUniform:opacityUniform program:self.filterProgram];
}
