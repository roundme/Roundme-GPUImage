...
- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    convolutionMatrixUniform = [self.filterProgram uniformIndex:@"convolutionMatrix"];
...
- (void)setConvolutionKernel:(GPUMatrix3x3)newValue;
{
    ...
    [self setMatrix3f:_convolutionKernel forUniform:convolutionMatrixUniform program:self.filterProgram];
}
