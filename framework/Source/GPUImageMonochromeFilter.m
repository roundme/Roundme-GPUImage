...
- (id)init;
{
    ...
    intensityUniform = [self.filterProgram uniformIndex:@"intensity"];
    filterColorUniform = [self.filterProgram uniformIndex:@"filterColor"];
...
- (void)setColorRed:(GLfloat)redComponent green:(GLfloat)greenComponent blue:(GLfloat)blueComponent;
{
    ...
    [self setVec3:filterColor forUniform:filterColorUniform program:self.filterProgram];
}

- (void)setIntensity:(GLfloat)newValue;
{
    _intensity = newValue;
    
    [self setFloat:_intensity forUniform:intensityUniform program:self.filterProgram];
}
