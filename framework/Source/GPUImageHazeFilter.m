...
- (id)init;
{
    ...
    distanceUniform = [self.filterProgram uniformIndex:@"hazeDistance"];
	slopeUniform = [self.filterProgram uniformIndex:@"slope"];
...
- (void)setDistance:(GLfloat)newValue;
{
    _distance = newValue;
    
    [self setFloat:_distance forUniform:distanceUniform program:self.filterProgram];
}

- (void)setSlope:(GLfloat)newValue;
{
    _slope = newValue;
    
    [self setFloat:_slope forUniform:slopeUniform program:self.filterProgram];
}
