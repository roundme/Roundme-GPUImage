...
@property(readwrite, nonatomic) GLfloat topFocusLevel;
...
@property(readwrite, nonatomic) GLfloat bottomFocusLevel; 

/// The rate at which the image gets blurry away from the in-focus region, default 0.2
@property(readwrite, nonatomic) GLfloat focusFallOffRate; 
