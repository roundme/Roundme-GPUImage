...
- (id)init;
{
    ...
    crossHatchSpacingUniform = [self.filterProgram uniformIndex:@"crossHatchSpacing"];
    lineWidthUniform = [self.filterProgram uniformIndex:@"lineWidth"];
...
- (void)setCrossHatchSpacing:(GLfloat)newValue {
    GLfloat singlePixelSpacing;
    CGSize inputSize = [self getInputSize:0];
    if (inputSize.width != 0.0f) {
        singlePixelSpacing = 1.0f / inputSize.width;
    } else {
    ...
    [self setFloat:_crossHatchSpacing forUniform:crossHatchSpacingUniform program:self.filterProgram];
}

- (void)setLineWidth:(GLfloat)newValue;
{
    _lineWidth = newValue;
    
    [self setFloat:_lineWidth forUniform:lineWidthUniform program:self.filterProgram];
}
