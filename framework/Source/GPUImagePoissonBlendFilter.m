...
- (id)init;
{
    ...
    mixUniform = [self.filterProgram uniformIndex:@"mixturePercent"];
    self.mix = 0.5;
...
- (void)setMix:(GLfloat)newValue;
{
    ...
    [self setFloat:_mix forUniform:mixUniform program:self.filterProgram];
}
...
//            glVertexAttribPointer(self.filterTextureCoordinateAttribute, 2, GL_FLOAT, 0, 0, [[self class] textureCoordinatesForRotation:kGPUImageNoRotation]);
