...
//    NSLog(@"Byte 1: %d, %d, %d, byte 2: %d, %d, %d, byte 3: %d, %d, %d", byteAtOne.red, byteAtOne.green, byteAtOne.blue, byteAtWidth.red, byteAtWidth.green, byteAtWidth.blue, byteAtHeight.red, byteAtHeight.green, byteAtHeight.blue);
    ...
    if (outputBGRA)    
    {
        GPUByteColorVector flippedColor = imageColorBytes[(int)(roundf((locationToPickFrom.y * imageSize.width) + locationToPickFrom.x))];
    ...
    {
        return imageColorBytes[(int)(roundf((locationToPickFrom.y * imageSize.width) + locationToPickFrom.x))];
    }
}
