...
- (id)init;
{
    ...
    brightnessUniform = [self.filterProgram uniformIndex:@"brightness"];
    self.brightness = 0.0;
...
- (void)setBrightness:(GLfloat)newValue;
{
    _brightness = newValue;
    
    [self setFloat:_brightness forUniform:brightnessUniform program:self.filterProgram];
}
