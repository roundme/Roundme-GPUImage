...
- (id)init;
{
    ...
    gammaUniform = [self.filterProgram uniformIndex:@"gamma"];
    self.gamma = 1.0;
...
- (void)setGamma:(GLfloat)newValue;
{
    _gamma = newValue;
    
    [self setFloat:_gamma forUniform:gammaUniform program:self.filterProgram];
}
