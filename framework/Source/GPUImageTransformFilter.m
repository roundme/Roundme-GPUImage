...
- (id)init;
{
    ...
    transformMatrixUniform = [self.filterProgram uniformIndex:@"transformMatrix"];
    orthographicMatrixUniform = [self.filterProgram uniformIndex:@"orthographicMatrix"];
...
//    GLfloat normalizedHeight = currentFBOSize.height / currentFBOSize.width;
//    
...
//		if (_anchorTopLeft)
//		{
//			[self renderToTextureWithVertices:squareVerticesAnchorTL textureCoordinates:[[self class] textureCoordinatesForRotation:self.inputRotation]];
//		}
//		else
//		{
//			[self renderToTextureWithVertices:squareVertices textureCoordinates:[[self class] textureCoordinatesForRotation:self.inputRotation]];
//		}
//    }
//    else
//    {
//		if (_anchorTopLeft)
//		{
//			[self renderToTextureWithVertices:adjustedVerticesAnchorTL textureCoordinates:[[self class] textureCoordinatesForRotation:self.inputRotation]];
//		}
//		else
//		{
//			[self renderToTextureWithVertices:adjustedVertices textureCoordinates:[[self class] textureCoordinatesForRotation:self.inputRotation]];
//		}
//    }
//    
...
- (void)setupFilterForSize:(CGSize)filterFrameSize;
{
    if (!_ignoreAspectRatio)
    {
        ...
        [self setMatrix4f:orthographicMatrix forUniform:orthographicMatrixUniform program:self.filterProgram];
    }
}
...
- (void)setTransform3D:(CATransform3D)newValue;
{
    ...
    [self setMatrix4f:temporaryMatrix forUniform:transformMatrixUniform program:self.filterProgram];
}
