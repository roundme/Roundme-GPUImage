...
- (id)init;
{
    ...
    inputTileSizeUniform = [self.filterProgram uniformIndex:@"inputTileSize"];
    displayTileSizeUniform = [self.filterProgram uniformIndex:@"displayTileSize"];
    numTilesUniform = [self.filterProgram uniformIndex:@"numTiles"];
    colorOnUniform = [self.filterProgram uniformIndex:@"colorOn"];
...
- (void)setInputTileSize:(CGSize)inputTileSize
{
    ...
    [self setSize:_inputTileSize forUniform:inputTileSizeUniform program:self.filterProgram];
}
...
-(void)setDisplayTileSize:(CGSize)displayTileSize
{
    ...
    [self setSize:_displayTileSize forUniform:displayTileSizeUniform program:self.filterProgram];
}
