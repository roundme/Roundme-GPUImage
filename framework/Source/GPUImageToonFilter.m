...
- (id)init;
{
    ...
    thresholdUniform = [self.filterProgram uniformIndex:@"threshold"];
    quantizationLevelsUniform = [self.filterProgram uniformIndex:@"quantizationLevels"];
...
- (void)setThreshold:(GLfloat)newValue;
{
    ...
    [self setFloat:_threshold forUniform:thresholdUniform program:self.filterProgram];
}
...
- (void)setQuantizationLevels:(GLfloat)newValue;
{
    ...
    [self setFloat:_quantizationLevels forUniform:quantizationLevelsUniform program:self.filterProgram];
}
