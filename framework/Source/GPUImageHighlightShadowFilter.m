...
- (id)init;
{
    ...
    shadowsUniform = [self.filterProgram uniformIndex:@"shadows"];
	highlightsUniform = [self.filterProgram uniformIndex:@"highlights"];
...
- (void)setShadows:(GLfloat)newValue;
{
    _shadows = newValue;

    [self setFloat:_shadows forUniform:shadowsUniform program:self.filterProgram];
}

- (void)setHighlights:(GLfloat)newValue;
{
	_highlights = newValue;

    [self setFloat:_highlights forUniform:highlightsUniform program:self.filterProgram];
}
