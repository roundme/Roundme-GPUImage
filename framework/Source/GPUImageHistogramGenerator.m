...
- (id)init;
{
    ...
    backgroundColorUniform = [self.filterProgram uniformIndex:@"backgroundColor"];
...
//    backgroundColor[3] = alphaComponent;
    ...
    [self setVec4:backgroundColor forUniform:backgroundColorUniform program:self.filterProgram];
}
