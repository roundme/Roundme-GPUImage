...
- (id)init;
{
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        crosshairWidthUniform = [self.filterProgram uniformIndex:@"crosshairWidth"];
        crosshairColorUniform = [self.filterProgram uniformIndex:@"crosshairColor"];
        
        self.crosshairWidth = 5.0f;
        [self setCrosshairColorRed:0.0f green:1.0f blue:0.0f];
    });
...
- (void)setCrosshairWidth:(GLfloat)newValue {
    _crosshairWidth = newValue;
    
    [self setFloat:_crosshairWidth forUniform:crosshairWidthUniform program:self.filterProgram];
}
...
- (void)setCrosshairColorRed:(GLfloat)redComponent green:(GLfloat)greenComponent blue:(GLfloat)blueComponent;
{
    ...
    [self setVec3:crosshairColor forUniform:crosshairColorUniform program:self.filterProgram];
}
