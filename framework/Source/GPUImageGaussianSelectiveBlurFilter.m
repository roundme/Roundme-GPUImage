...
- (void)setInputSize:(CGSize)value index:(NSUInteger)index {
    ...
    if ((!hasOverriddenAspectRatio) && (!CGSizeEqualToSize(value, CGSizeZero))) {
        GLfloat aspectRatio = (value.width / value.height);
        [selectiveFocusFilter setFloat:aspectRatio forUniformName:@"aspectRatio"];
    }
}
...
- (void)setAspectRatio:(GLfloat)newValue {
    ...
    [selectiveFocusFilter setFloat:newValue forUniformName:@"aspectRatio"];
}
