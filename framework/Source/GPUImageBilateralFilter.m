...
- (id)init;
{
    ...
    firstDistanceNormalizationFactorUniform  = [self.filterProgram uniformIndex:@"distanceNormalizationFactor"];
    secondDistanceNormalizationFactorUniform = [self.filterProgram uniformIndex:@"distanceNormalizationFactor"];

    self.texelSpacingMultiplier = 4.0f;
    self.distanceNormalizationFactor = 8.0f;
