...
- (id)init;
{
    ...
    blurSizeUniform = [self.filterProgram uniformIndex:@"blurSize"];
    blurCenterUniform = [self.filterProgram uniformIndex:@"blurCenter"];
...
- (void)setBlurSize:(GLfloat)newValue;
{
    ...
    [self setFloat:_blurSize forUniform:blurSizeUniform program:self.filterProgram];
}

- (void)setBlurCenter:(CGPoint)newValue {
    _blurCenter = newValue;
    [self setPoint:rotatedPoint(_blurCenter, [self getInputRotation:0]) forUniform:blurCenterUniform program:self.filterProgram];
}
