...
@property(readwrite, nonatomic) GLfloat lowPassFilterStrength;

// For every frame, this will feed back the calculated centroid of the motion, as well as a relative intensity.
@property(nonatomic, copy) void(^motionDetectionBlock)(CGPoint motionCentroid, GLfloat motionIntensity, CMTime frameTime);
