...
- (id)init;
{
    ...
    firstColorUniform = [self.filterProgram uniformIndex:@"firstColor"];
    secondColorUniform = [self.filterProgram uniformIndex:@"secondColor"];
...
- (void)setFirstColorRed:(GLfloat)redComponent green:(GLfloat)greenComponent blue:(GLfloat)blueComponent;
{
    ...
    [self setVec3:firstColor forUniform:firstColorUniform program:self.filterProgram];
}
...
- (void)setSecondColorRed:(GLfloat)redComponent green:(GLfloat)greenComponent blue:(GLfloat)blueComponent;
{
    ...
    [self setVec3:secondColor forUniform:secondColorUniform program:self.filterProgram];
}
