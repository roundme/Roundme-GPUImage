...
- (id)init;
{
    ...
    rangeReductionUniform = [self.filterProgram uniformIndex:@"rangeReduction"];
...
- (void)setRangeReductionFactor:(GLfloat)newValue;
{
    _rangeReductionFactor = newValue;
    
    [self setFloat:_rangeReductionFactor forUniform:rangeReductionUniform program:self.filterProgram];
}
