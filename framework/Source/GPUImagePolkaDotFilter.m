...
- (id)init;
{
    ...
    dotScalingUniform = [self.filterProgram uniformIndex:@"dotScaling"];
...
- (void)setDotScaling:(GLfloat)newValue;
{
    _dotScaling = newValue;
    
    [self setFloat:_dotScaling forUniform:dotScalingUniform program:self.filterProgram];
}
