...
- (id)init;
{
    ...
    contrastUniform = [self.filterProgram uniformIndex:@"contrast"];
    self.contrast = 1.0;
...
- (void)setContrast:(GLfloat)newValue;
{
    _contrast = newValue;
    
    [self setFloat:_contrast forUniform:contrastUniform program:self.filterProgram];
}
