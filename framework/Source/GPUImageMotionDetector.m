...
- (id)init;
{
    ...
    [averageColor setColorAverageProcessingFinishedBlock:^(GLfloat redComponent, GLfloat greenComponent, GLfloat blueComponent, GLfloat alphaComponent, CMTime frameTime) {
...
- (void)setLowPassFilterStrength:(GLfloat)newValue;
{
    lowPassFilter.filterStrength = newValue;
}

- (GLfloat)lowPassFilterStrength;
{
