...
- (id)init;
{
    ...
    exposureUniform = [self.filterProgram uniformIndex:@"exposure"];
    self.exposure = 0.0f;
...
- (void)setExposure:(GLfloat)newValue;
{
    _exposure = newValue;
    
    [self setFloat:_exposure forUniform:exposureUniform program:self.filterProgram];
}
