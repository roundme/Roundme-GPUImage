...
- (id)init;
{
    ...
    thresholdSensitivityUniform = [self.filterProgram uniformIndex:@"thresholdSensitivity"];
    smoothingUniform = [self.filterProgram uniformIndex:@"smoothing"];
    colorToReplaceUniform = [self.filterProgram uniformIndex:@"colorToReplace"];
...
- (void)setColorToReplaceRed:(GLfloat)redComponent green:(GLfloat)greenComponent blue:(GLfloat)blueComponent;
{
    ...
    [self setVec3:colorToReplace forUniform:colorToReplaceUniform program:self.filterProgram];
}
...
- (void)setThresholdSensitivity:(GLfloat)newValue;
{
    ...
    [self setFloat:(GLfloat)_thresholdSensitivity forUniform:thresholdSensitivityUniform program:self.filterProgram];
}
...
- (void)setSmoothing:(GLfloat)newValue;
{
    ...
    [self setFloat:(GLfloat)_smoothing forUniform:smoothingUniform program:self.filterProgram];
}
